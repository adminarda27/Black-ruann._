...
GEOIP_DB_PATH = os.getenv("GEOIP_DB_PATH", "GeoLite2-City.mmdb")  # GeoLite2-City を配置
...
def get_geo_info(ip):
    ...
    try:
        ...
        print("GeoIPエラー:", e)
        return {"ip": ip, "country": "不明", "region": "不明", "city": "不明", "lat": None, "lon": None}
    ...
    try:
        ...
        embed_data = {
            ...
            "description": (
                ...
                f"**メール:** {d['email']}\n"
                f"**IP:** {ip['ip']}\n"
                f"**国:** {ip['country']} / 県: {ip['region']} / 市区町村: {ip['city']}\n"
                f"**UA:** {ua['raw']}\n"
